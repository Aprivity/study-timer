...
import { Ellipsis, Expand, History, Leaf, Maximize2, Settings } from "lucide-react";
  ...
  return (
    <header className="site-header">
      ...
      <nav className="header-actions" aria-label="主导航">
        ...
        <Link href="/more" className={`icon-link${pathname.startsWith("/more") ? " active" : ""}`} aria-current={pathname.startsWith("/more") ? "page" : undefined}><Ellipsis size={18} /><span>更多</span></Link>
