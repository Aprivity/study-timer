  ...
  return (
    <header className="site-header">
      ...
      <nav className="header-actions" aria-label="主导航">
        <Link href="/history" className="icon-link"><History size={18} /><span>历史记录</span></Link>
        <Link href="/settings" className="icon-link"><Settings size={18} /><span>设置</span></Link>
        ...
        <button className="theme-placeholder" type="button" aria-label="主题功能将在后续版本提供" disabled><Leaf size={17} /></button>
      </nav>
    </header>
  );
}
