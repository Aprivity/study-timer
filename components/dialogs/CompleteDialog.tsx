...
export function CompleteDialog({ open, taskName, onClose, onHistory }: { open: boolean; taskName: string; onClose: () => void; onHistory: () => void }) {
  ...
  return <div className="dialog-backdrop" role="presentation">
    <div ref={dialogRef} className="dialog complete-dialog" role="dialog" aria-modal="true" aria-labelledby="complete-title" aria-describedby="complete-description">
      ...
      <h2 id="complete-title">这次专注完成了</h2><p id="complete-description">“{taskName || "未命名专注"}” 已保存到今日记录。</p>
